require 'spec_helper'
require 'thron/gateway/apps_admin'
...
describe Thron::Gateway::AppsAdmin do
  ...
  let(:capabilities) { entity::new(add_capabilities: [], add_user_roles: Array::new(3) { |i| "APP#{i}_MANAGER" }).to_payload }
  ...
  it 'must call post to add snippet to the app' do
    ...
    data = entity::new(vesrion: 1.3, status: 'active', snippet_type: 'STANDARD', display_name: 'snippet_1', description: 'standard snippet 1').to_payload
    body = { 
      clientId: instance.client_id, 
      appId: app_id,
      snippet: data,
  ...
  it 'must call post to create a new app' do
    ...
    data = entity::new(pretty_id: 'BLUE-SUEDE-666', app_type: 'GRAMMY_WINNER', active: true, display_name: 'blue suede shoes', description: 'dont you step on my blue suede shoes', can_disguise: true).to_payload
    options = entity::new(root_category_id: '666', caps: { add_capabilities: [], add_user_roles: Array::new(3) { |i| "APP#{i}_MANAGER" } }).to_payload
    body = { 
      clientId: instance.client_id, 
      app: data,
      options: options
  ...
  it 'must call post to update an existing app' do
    ...
    data = entity::new(pretty_id: 'BLUE-SUEDE-666', app_type: 'GRAMMY_WINNER', active: true, display_name: 'blue suede shoes', description: 'dont you step on my blue suede shoes', can_disguise: true).to_payload
    capabilities = entity::new(capabilities: [], roles: Array::new(3) { |i| "APP#{i}_MANAGER" }).to_payload
    body = { 
      clientId: instance.client_id, 
      appId: app_id,
      update: data,
