...
describe Thron::Entity::Image do
  ...
  describe 'valid path' do
    ...
    it 'must initialize instance with specifies attributes' do
      mime_type = 'application/json'
      buffer = [86,112,-74] 
      instance = klass::new(path: file.path, mime_type: mime_type, buffer: buffer)
  ...
  it 'must return the instance if path is not existent' do
    instance = klass::new(path: 'noent')
    instance.must_be_instance_of klass
    instance.buffer.must_be_empty
    instance.mime_type.must_be_nil
  end
end
