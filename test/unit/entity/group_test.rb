...
describe Thron::Entity::Group do
  ...
  it 'must return payload form' do
    entity = klass::new('184f842e-8ca2-4c26-9bfd-719a85a2a73f', 'PLATFORM', true, 'group_1', 'Group 1 description', %w[capability1], %w[role1 role2 role3], %w[solution1 solution2])  
  ...
  it 'must add update data to payload' do
    ...
    entity = klass::new('184f842e-8ca2-4c26-9bfd-719a85a2a73f', 'PLATFORM', true, 'group_1', 'Group 1 description', %w[capability1], %w[role1 role2 role3], %w[solution1 solution2], metadata, patches)
